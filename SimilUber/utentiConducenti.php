<html>
<head>
    <title>utenti conducenti</title>
</head>
<body style="background-color:lightblue">
	
	<h1><p align="center">Elenco degli utenti conducenti presenti nella piattaforma </p> </h1>
	<?php 
		...
		$sql = "select U.nome, U.cognome from utente U where numero_patente is not NULL;";
